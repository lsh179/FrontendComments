        ...
        _calcmatchsize:function () {
            ...
            for(var i=0;i<tobj.colopts.length;i++)
            {
                ...
                for(var j=0;j<trs.length;j++){
                    // console.log(copt.$ele.css("min-width"));
                    var tds=trs.eq(j).find("td");
                    
                    if(i==tobj.colopts.length-1){
                        tds.eq(i).css("width",parseInt(copt.$ele.css("min-width")));
                    }else{
                        tds.eq(i).css("min-width",parseInt(copt.$ele.css("min-width")));
                    }
            ...
            var theadWidth=parseInt($(this.$ele).find("thead").css("width"));
            
            if(theadWidth > awidth){
                
                var addWidth=theadWidth-awidth;
