...
$.extend({
    ...
    showModal:function(opt){
        ...
        switch (options.type){
            case $.ModalType.Base:
                view = $('<div class="ui-modal-box-full"><div class="ui-modal-box"> <span class="ui-modal-title">$title$</span> <span class="ui-modal-message">$message$</span><div class="ui-modal-footer"><button class="lm-btn lm-btn-theme lm-bnt-done">确定</button><button class="lm-btn lm-btn-default lm-bnt-cancel">取消</button></div></div></div>'.bind(options));
                break;
        ...
        $(view.find(".lm-bnt-cancel")).click(function(){
            view.hide();
            view.remove();
        });

        $(view.find(".lm-bnt-done")).click(function(){
            if(options.ok){
                switch (options.type) {
                    case $.ModalType.Base:
                        options.ok();
